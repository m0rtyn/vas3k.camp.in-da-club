...
function buildMockMeetings(): Meeting[] {
  ...
  for (const day of schedule) {
    for (const hour of day.hours) {
      ...
      out.push({
        ...
        initiator_display_name: isInitiator ? me.display_name : peer.display_name,
        ...
        target_display_name: isInitiator ? peer.display_name : me.display_name,
        witness_code: null,
  ...
  for (let k = 0; k < 4; k++) {
    ...
    out.push({
      ...
      initiator_display_name: a.display_name,
      target_username: b.username,
      target_camp_username: b.camp_username,
      target_display_name: b.display_name,
      witness_code: null,
      witness_code_expires_at: null,
  ...
  out.push({
    ...
    initiator_display_name: me.display_name,
    target_username: 'ghost',
    target_camp_username: 'ghost-user',
    target_display_name: 'Призрак',
    witness_code: null,
    witness_code_expires_at: null,
