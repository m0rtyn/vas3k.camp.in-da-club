    ...
    <article className={styles.page}>
      ...
      <section className={styles.section} aria-labelledby="about-howto">
        ...
        <ol className={styles.steps}>
          <li className={styles.step}>
            ...
            <div className={styles.stepBody}>
              ...
              <div className={styles.stepDesc}>
                Открой его профиль, приложив телефон к NFC-бейджику, или введи его{' '}
                <Hint label={<>юзернейм</>}>
                  Это НЕ ник из клуба 🤓 — юзернейм придётся спросить.
                  Свой ты найдёшь в <Link to="/profile">профиле</Link>, он легко запоминается.
                </Hint>{' '}
                в адресной строке.
                <br />
                Например: <code>vk.vas3k.cloud/<strong>smart_dura4ok</strong></code>
              </div>
            </div>
          </li>
          <li className={styles.step}>
          ...
          <li className={`${styles.step} ${styles.optionalStep}`}>
            <span className={styles.stepBadge} aria-hidden="true">
              3*
            </span>
            <div className={styles.stepBody}>
